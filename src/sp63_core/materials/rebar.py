...
REBAR_CATALOG: dict[str, Rebar] = {
    "A240": Rebar(class_name="A240", Rsn=240, Rs=210, Rsc=210, Rsw=170, Es=200_000),
    "A400": Rebar(class_name="A400", Rsn=400, Rs=350, Rsc=350, Rsw=280, Es=200_000),
    "A500": Rebar(class_name="A500", Rsn=500, Rs=435, Rsc=400, Rsw=300, Es=200_000),
}
