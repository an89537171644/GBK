...
class Rebar(BaseModel):
    ...
    @property
    def Rsc(self) -> float:
        """Backward-compatible default compression resistance."""
        return self.Rsc_short

    def get_Rsc(self, load_duration: LoadDuration = "short") -> float:
        """Return compression resistance by load duration."""
