...
| `dataset/diagnostic.py` | implemented deterministic diagnostic dataset with pass/fail/review rows | yes | yes | engineer review diagnostic cases before classification ML |
