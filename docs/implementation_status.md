...
| `materials/rebar.py` | draft | yes | yes | engineer review of material values |
...
| `dataset/generator.py` | draft; uses selected option section for `h0` | yes | yes | engineer review dataset ranges |
