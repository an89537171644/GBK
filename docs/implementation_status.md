...
| `cli.py` | implemented with subcommands including crack formation, crack width, deflection, separated design statuses, and design report export | yes | no | keep report/export commands smoke-tested |
