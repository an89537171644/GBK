...
| `report/design_report_input.py` | implemented JSON input loader for rectangular design reports | yes | yes | keep input schema explicit and reject unknown critical fields |
