...
- строки A400 390/340 МПа подтверждены по содержанию пользовательского скана
  СП 63.13330.2018 с Изменениями № 1 и № 2, SHA-256
  `8dfe7fc1af47d6adf2a4d91ed91ee92fe0762abe20a0c54b3c248c7ff138fe00`:
  страница 2 подтверждает состав и даты изменений, страницы 35–37 — строки
  A400 в таблицах 6.13–6.15; при этом подлинность, юридический статус и
  актуальность после Изменения № 2 остаются `OPEN_QUESTION`;
- подтверждение содержания артефакта не является инженерным утверждением
  формул или каталога материалов и не снимает обязательность независимой
  проверки;
